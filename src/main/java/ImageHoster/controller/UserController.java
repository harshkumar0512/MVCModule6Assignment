...
public class UserController {
    ...
    // This controller method will check if input String is matching the strong password criteria or not
    // If password is strong then method will return boolean true else false.
    private Boolean isPasswordStrong(String password){
        //Pattern.matches("(?=.*[a-z])(?=.*[0-9])(?=.*[^a-z0-9])", password);
