...
public class ImageController {
    ...
    public String editImage(@RequestParam("imageId") Integer imageId, Model model, HttpSession session, RedirectAttributes redirectAttrs) {
        ...
        if(isCurrentUserImageOwner(imageId,session)){
    ...
    // This controller method is use to check if current user is image Owner or not using Image instance and HttpSession
    // Using Image instance and HttpSession instance we are getting Image Id and compering them. Return true if matches else false
    private Boolean isCurrentUserImageOwner(Integer imageId, HttpSession session) {
